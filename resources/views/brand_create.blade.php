...
@section('main')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Add New Product Brand</h1>
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active"><a href="/brands/create"
                            aria-current="page">Add New Product Brand</a></li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card custom-card shadow-sm">
        <form action="/brands"
            ...
            <div class="card-header">
                <div class="card-title">New Brand Form</div>
            </div>
            <div class="card-body">
                <div class="mb-3">
                    <label for="name"
