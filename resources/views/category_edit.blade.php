...
@section('main')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Edit Product Category</h1>
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active"><a href="#"
                            aria-current="page">Edit Product Category</a></li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card custom-card shadow-sm">
        <form action="/categories/{{ encrypt($category_data->id) }}"
            method="POST">
            ...
            <div class="card-header">
                <div class="card-title">Edit Category Form</div>
            </div>
            <div class="card-body">
                <div class="mb-3">
                    <label for="name"
                    ...
                    <div class="input-group">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('name') ? old('name') : $category_data->name }}">
                        @error('name')
                    ...
                    <div class="input-group mt-1 mb-1 @error('status') is-invalid @enderror">
                        <div class="form-check me-3">
                            <input class="form-check-input @error('status') is-invalid @enderror"
                                ...
                                id="active"
                                value="active"
                                {{ (old('status') ? old('status') : $category_data->status) === 'active' ? 'checked' : '' }}>
                        ...
                        <div class="form-check me-3">
                            <input class="form-check-input @error('status') is-invalid @enderror"
                                ...
                                id="off"
                                value="off"
                                {{ (old('status') ? old('status') : $category_data->status) === 'off' ? 'checked' : '' }}>
                            <label class="form-check-label"
                                for="off">Off</label>
                        </div>
                    </div>
